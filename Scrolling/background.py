...
class FixedBackground:
    ...
    def update(self):
        # fill here
        self.window_left = clamp(0, int(server.boy.x) - self.canvas_width, self.w - self.canvas_width // 2 - 0)
        self.window_bottom = clamp(0, int(server.boy.y - self.canvas_height), self.h - self.canvas_height // 2 - 0)
